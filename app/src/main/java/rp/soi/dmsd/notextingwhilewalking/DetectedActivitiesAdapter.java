...
public class DetectedActivitiesAdapter extends ArrayAdapter<DetectedActivity> {
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        activityName.setText(rp.soi.dmsd.notextingwhilewalking.Constants.getActivityString(getContext(),
    ...
    protected void updateActivities(ArrayList<DetectedActivity> detectedActivities) {
        ...
        for (int i = 0; i < rp.soi.dmsd.notextingwhilewalking.Constants.MONITORED_ACTIVITIES.length; i++) {
            int confidence = detectedActivitiesMap.containsKey(rp.soi.dmsd.notextingwhilewalking.Constants.MONITORED_ACTIVITIES[i]) ?
                    detectedActivitiesMap.get(rp.soi.dmsd.notextingwhilewalking.Constants.MONITORED_ACTIVITIES[i]) : 0;
